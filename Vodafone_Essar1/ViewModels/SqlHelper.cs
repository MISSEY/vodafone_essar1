...
public sealed class SqlHelper
{
    ...
    private static void AssignParameterValues(SqlParameter[] commandParameters, DataRow dataRow)
	{
		...
		//SqlParameter commandParameter = default(SqlParameter);
		int i = 0;
    ...
    private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, ref bool mustCloseConnection)
    {
        ...
        // Set the command text (stored procedure name or SQL statVMSnt)
    ...
    public static DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
    {
        ...
        SqlDataAdapter dataAdatpter = default(SqlDataAdapter);
        bool mustCloseConnection = false;
    ...
    public static XmlReader ExecuteXmlReader(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
    {
        ...
        try
        {
            XmlReader retval = default(XmlReader);
    ...
    // Parameters:
    // -insertCommand: A valid transact-SQL statVMSnt or stored procedure to insert new records into the data source
    // -deleteCommand: A valid transact-SQL statVMSnt or stored procedure to delete records from the data source
    // -updateCommand: A valid transact-SQL statVMSnt or stored procedure used to update records in the data source
    ...
    // e.g.:  
    // Dim command As SqlCommand = CreateCommand(conn, "AdVPustomer", "CustomerID", "CustomerName")
    // Parameters:
...
public sealed class SqlHelperParameterCache
{
    ...
    public static SqlParameter[] GetSpParameterSet(SqlConnection connection, string spName, bool includeReturnValueParameter)
    {
        ...
        if ((connection == null))
            throw new ArgumentNullException("connection");
        SqlConnection cloneVPonnection = default(SqlConnection);
        try
        {
            cloneVPonnection = (SqlConnection)(((ICloneable)connection).Clone());
            functionReturnValue = GetSpParameterSetInternal(cloneVPonnection, spName, includeReturnValueParameter);
        }
        finally
        {
            if ((cloneVPonnection != null))
                cloneVPonnection.Dispose();
        }
        return functionReturnValue;
    }
    // GetSpParameterSet
